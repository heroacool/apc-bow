...
{
    Mat vocabulary;
    //if failed to read fro vocabulary file, then generate by self
			 ...
			 const string& resPath )
{
	...
	vector<ObdImage> images;        vector<Mat> bowImageDescriptors;
	vector<char> objectPresent;
...
int main(int argc, char** argv)
{
    ...
    string vocName;
    DDMParams ddmParams;    //desciptor parameter
    VocabTrainParams vocabTrainParams;      //Vocab train
    ...
    FileStorage paramsFS( resPath + "/" + paramsFile, FileStorage::READ );  //if it has generate the xml in the result fold ,
